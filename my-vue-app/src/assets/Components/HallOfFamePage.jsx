...
function HallOfFamePage() {
    const itemsData = [
      ...
      { imgSrc: 'https://res.cloudinary.com/dgpxvazru/image/upload/v1703341045/HallofFame/EnuL.jpg', category: 'Lecturers', Name: 'Dr Francis Enu', Position: 'Faculty Examination Officer' },
